...
export const CustomerDataForm = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      // Call Firebase service to create customer
      ...
      if (response.error) {
        ...
        if (response.error.includes('Email address already exists')) {
        ...
        toast({
          title: "Error",
          description: response.error || "Failed to save customer data",
          variant: "destructive",
        });
        return;
      }
